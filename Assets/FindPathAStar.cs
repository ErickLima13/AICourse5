...
public class FindPathAStar : MonoBehaviour
{
    ...
    private void BeginSearch()
    {
        ...
        Vector3 starLocation = new(locations[0].x * maze.scale, 0, locations[0].z * maze.scale);
        startNode = new PathMarker(new MapLocation(locations[0].x, locations[0].z), 0, 0, 0,
            Instantiate(start, starLocation, Quaternion.identity), null);
    ...
    private void GetPath()
    {
        ...
        Instantiate(pathP, 
            new Vector3(startNode.location.x * maze.scale, 0, startNode.location.z * maze.scale), Quaternion.identity);
    }
